...
def lottery_pl35(term):
    # 方法和大乐透一样
    # url='http://www.lottery.gov.cn/api/lottery_kj_detail_new.jspx?_ltype=5&_term=17129'
    url = 'http://www.lottery.gov.cn/api/lottery_kj_detail_new.jspx?_ltype=5&_term={}'.format(term)

    web=requests.get(url,headers=headers)

    json=web.json()
    print(json[0]['codeNumber'])
    print(json[0]['codeNumberPlw'])